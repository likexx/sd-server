...
images = pipeline(prompt="likezhang is sitting behind a table in the president room in the White House in US, {likezhang}, close up, view from front, 8k", num_images_per_prompt=4).images
i=1
for img in images:
